...
- `docs/../03_implementation/03_implementation_common_patterns.md` - Batch File Analysis Process section
- `docs/../04_reference/04_reference_conversion_table.md` - Syntax lookup only (not primary reference)
...
**→** Start with [../01_analysis/01_analysis_overview.md](../01_analysis/01_analysis_overview.md) for Phase 0 analysis context, then read [`CLAUDE.md`](../.claude/CLAUDE.md) for full architecture
...
**→** Follow the sequential guide in [`docs/../03_implementation/03_implementation_common_patterns.md`](../03_implementation/03_implementation_common_patterns.md) for phase-by-phase steps
...
**→** Use the reference table in [`docs/../04_reference/04_reference_conversion_table.md`](../04_reference/04_reference_conversion_table.md) for command-by-command conversion patterns
...
**→** Read [../01_analysis/01_analysis_detailed.md](../01_analysis/01_analysis_detailed.md) which contains complete flow diagrams and line-by-line analysis
...
**→** Consult [../02_planning/02_planning_phases.md](../02_planning/02_planning_phases.md) for all 5 phases with 237+ scripts listed
...
**→** Check the Troubleshooting section in [`docs/../03_implementation/03_implementation_common_patterns.md`](../03_implementation/03_implementation_common_patterns.md)
...
**→** Review the Testing Checklist in [`docs/../03_implementation/03_implementation_common_patterns.md`](../03_implementation/03_implementation_common_patterns.md)
...
- **[../01_analysis/01_analysis_overview.md](../01_analysis/01_analysis_overview.md)** - Phase 0 overview + navigation
- **[../01_analysis/01_analysis_detailed.md](../01_analysis/01_analysis_detailed.md)** - Flow diagrams + line-by-line analysis of EasyReforgeInstaller.bat
- **[ANALYSIS_SUMMARY.md](../01_analysis/01_analysis_summary.md)** - High-level summary of original installer
- **[easyreforge_analysis.md](../01_analysis/01_analysis_technical.md)** - Comprehensive technical reference

### Planning & Timeline
- **[../02_planning/02_planning_phases.md](../02_planning/02_planning_phases.md)** - Complete phase breakdown + script inventory (all 237 files)
- **[implementation_plan.md](../02_planning/02_planning_phases.md)** - Detailed execution plan

### Implementation Guides
- **[common_patterns.md](../03_implementation/03_implementation_common_patterns.md)** - Step-by-step implementation with cautions
- **[phase_1.md](../03_implementation/03_implementation_phase1.md)** - Phase 1 specific details
- **[phase_2.md](../03_implementation/03_implementation_phase2.md)** - Phase 2 specific details (CRITICAL - reforge.sh)
- **[../03_implementation/03_implementation_phase3.md](../03_implementation/03_implementation_phase3.md)** - Phase 3 template for development
- **[../03_implementation/03_implementation_phase4.md](../03_implementation/03_implementation_phase4.md)** - Phase 4 template for development
- **[../03_implementation/03_implementation_phase5.md](../03_implementation/03_implementation_phase5.md)** - Phase 5 template for development

### Reference Materials
- **[batch_to_shell_conversion.md](../04_reference/04_reference_conversion_table.md)** - Quick lookup tables for all conversions
...
4. **../03_implementation/03_implementation_phase2.md** (template) - For Phase 2 work tracking
5. **../03_implementation/03_implementation_phase3.md** (template) - For Phase 3 work tracking
6. **../03_implementation/03_implementation_phase4.md** (template) - For Phase 4 work tracking
7. **../03_implementation/03_implementation_phase5.md** (template) - For Phase 5 work tracking
...
2. Read `../01_analysis/01_analysis_overview.md` (15 min)
3. Skim `../02_planning/02_planning_phases.md` Part 1 for overview (10 min)
4. Deep-dive `docs/../03_implementation/03_implementation_common_patterns.md` for patterns (1 hour)
5. Keep `batch_to_shell_conversion.md` open while coding

**Total**: ~2 hours to be ready

### I'm Implementing Phase 1
1. Read `../02_planning/02_planning_phases.md` Part 2 - Phase 1 section (10 min)
...
1. Read `../02_planning/02_planning_phases.md` Part 2 - Phase 2 section (15 min)
2. Read `common_patterns.md` - Phase 2 section (45+ min - EXTENSIVE CAUTIONS)
3. Read `.claude/CLAUDE.md` - Caution sections (20 min)
4. Have `batch_to_shell_conversion.md` + `../03_implementation/03_implementation_phase2.md` open

**Critical attention**: Spend extra time on PyTorch wheel section

### I'm Implementing Phases 3-4 (Download Scripts)
1. Read `../02_planning/02_planning_phases.md` Part 2 - Phase 3-4 sections (15 min)
...
3. Use `../04_reference/04_reference_checklist.md` for validation
...
│  ├─ ../01_analysis/01_analysis_overview.md (entry point)
│  ├─ ../01_analysis/01_analysis_detailed.md (flow diagrams + annotations)
│  ├─ ../01_analysis/01_analysis_summary.md (high-level overview)
│  └─ ../01_analysis/01_analysis_technical.md (comprehensive reference)
│
├─ PHASE 1-5 PLANNING (Planning Complete ✅)
│  ├─ ../02_planning/02_planning_phases.md (phases 1-5 overview)
│  └─ ../02_planning/02_planning_overview.md (Japanese project overview)
│
├─ IMPLEMENTATION GUIDES
│  ├─ ../03_implementation/03_implementation_common_patterns.md ⭐ MAIN REFERENCE
│  ├─ ../03_implementation/03_implementation_phase1.md (Phase 1 specifics)
│  ├─ ../03_implementation/03_implementation_phase2.md (Phase 2 specifics)
│  ├─ ../03_implementation/03_implementation_phase3.md (Phase 3 specifics)
│  ├─ ../03_implementation/03_implementation_phase4.md (Phase 4 specifics)
│  └─ ../03_implementation/03_implementation_phase5.md (Phase 5 specifics)
│
└─ REFERENCE MATERIALS
   ├─ ../04_reference/04_reference_conversion_table.md (quick lookup)
   ├─ ../04_reference/04_reference_checklist.md (validation)
   ├─ ../04_reference/04_reference_known_issues.md (troubleshooting)
   ├─ ../04_reference/04_reference_troubleshooting.md (additional help)
...
→ **../02_planning/02_planning_phases.md** Part 1 + **common_patterns.md** Phase X section

### "How does the original script work?"
→ **../01_analysis/01_analysis_detailed.md** or **easyreforge_analysis.md**

### "What's the full scope?"
→ **../02_planning/02_planning_phases.md** Part 2 (all 237 scripts listed)
...
### For Collaboration
- Link to specific sections when asking questions: `docs/../03_implementation/03_implementation_common_patterns.md#phase-2`
...
│
├── ../01_analysis/01_analysis_overview.md                    ← Phase 0: Overview
├── ../01_analysis/01_analysis_summary.md                     ← Phase 0: Summary
├── ../01_analysis/01_analysis_technical.md                   ← Phase 0: Technical deep-dive
├── ../01_analysis/01_analysis_detailed.md                    ← Phase 0: Flow diagrams + line-by-line
│
├── ../02_planning/02_planning_overview.md                    ← Japanese project overview
├── ../02_planning/02_planning_phases.md                      ← Phases 1-5 + script inventory
│
├── ../03_implementation/03_implementation_common_patterns.md       ← MAIN REFERENCE for implementation
├── ../03_implementation/03_implementation_phase1.md                ← Phase 1 specifics
├── ../03_implementation/03_implementation_phase2.md                ← Phase 2 specifics
├── ../03_implementation/03_implementation_phase3.md                ← Phase 3 specifics
├── ../03_implementation/03_implementation_phase4.md                ← Phase 4 specifics
├── ../03_implementation/03_implementation_phase5.md                ← Phase 5 specifics
│
├── ../04_reference/04_reference_conversion_table.md           ← Command conversion reference
├── ../04_reference/04_reference_checklist.md                  ← Testing & validation checklist
├── ../04_reference/04_reference_known_issues.md               ← Known issues & workarounds
├── ../04_reference/04_reference_troubleshooting.md            ← Troubleshooting guide
│
└── .claude/
...
1. Read the phase section in `../02_planning/02_planning_phases.md`
